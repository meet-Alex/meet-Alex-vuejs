  ...
  <div class="container">
    <template v-if="userinfo.loggedin">
      <div>
        ...
        <b-button v-on:click="cancel" variant="primary">Cancel</b-button>
      </div>
    </template>
    ...
    <template v-if="!userinfo.loggedin">
      ...
      <b-form @submit="onSubmit1">
        ...
        <template v-if="isRegister">
          <b-form-group horizontal  label="Confirm Password:" label-for="confirmPasswordInput">
          ...
          <b-button :disabled="!registerOk"  v-on:click="onSubmit" variant="primary">Register</b-button>
          <b-button v-on:click="cancel" variant="primary">Cancel</b-button>
          <div>
        ...
        <template v-else>
          ...
          -->
          <b-button :disabled="!loginOk" v-on:click="onSubmit" variant="primary">Login</b-button>
          <b-button v-on:click="cancel" variant="primary">Cancel</b-button>
  ...
  methods: {
    ...
    login: function() {
      this.$store
        ...
        .then(() => {
          console.log('logging in...', this.getLogin())
          
          if (this.getLogin().loggedin) {
            this.$router.go(-1);
          }
        });
    },
